...
a0 = Point("0±0", "0	±	0", "M a vuoto")
a1 = Point("0,000012	±	0,000001", "0,11	±	0,02","Fa2 1cm")
a2 = Point("0,000023	±	0,000001","0,21	±	0,02","Fa2 2cm")
a3= Point('0,000035	±	0,000001','0,31	±	0,02','Fa2 3cm')
a4= Point('0,000046	±	0,000001','0,40	±	0,02','Fa2 4 cm')
a5= Point('0,000058	±	0,000002','0,51	±	0,02','Fa2 5 cm')
a6= Point('0,000069	±	0,000002','0,61	±	0,02','Fa2 6 cm')
