...
a1 = Point("0,000012	±	0,000001", "0,14	±	0,04","1cm")
a2 = Point("0,000023	±	0,000001","0,30	±	0,04","2cm")
a3= Point('0,000035	±	0,000001','0,44	±	0,04','3cm')
a4= Point('0,000046	±	0,000001','0,60	±	0,04','4 cm')
a5= Point('0,000058	±	0,000002','0,74 ±	0,04','5 cm')
a6= Point('0,000069	±	0,000002','0,88 ±	0,04','6 cm')
